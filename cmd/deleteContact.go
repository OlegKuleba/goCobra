...
// deleteContactCmd represents the deleteContact command
...
func init() {
	...
	// deleteContactCmd.PersistentFlags().String("foo", "", "A help for foo")

	// Cobra supports local flags which will only run when this command
	// is called directly, e.g.:
	// deleteContactCmd.Flags().BoolP("toggle", "t", false, "Help message for toggle")
}
